...
import styles from '@/app/group/modules/styles/group.module.scss'
import GroupComponents from '@/app/group/modules/components/ui/GroupComponents'
// import { GroupList } from '../ui/GroupList'
import Image from 'next/image'
import { Pagination, GROUP_TYPE_OPTIONS, STATUS_OPTIONS, Typo16, GroupSwitch } from '@/paths'
import { GroupSearchSection } from '@/app/group/modules/components/ui/GroupSearchSection'
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <GroupComponents.ButtonGroupRegister
          text="그룹등록"
          styles={styles}
